...
import { LayoutDashboard, Briefcase, FileText, User, LogOut, Sparkles, Radar, FileCog, CalendarDays, Menu, ScanSearch } from "lucide-react";
...
const nav = [
  ...
  { to: "/matches", label: "Matcher", icon: ScanSearch },
